...
// ── Select Address Banner ─────────────────────────────────────────
function SelectAddressBanner({ visible }) {
  ...
  return (
    <div style={{
      ...
      transition: "opacity 0.6s ease 0.2s, transform 0.6s cubic-bezier(.34,1.56,.64,1) 0.2s",
      maxWidth: 680, margin: "0 auto 32px",
      padding: "0 20px",
    }}>
      {/* Divider */}
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
        <div style={{ flex: 1, height: 1, background: "linear-gradient(90deg,transparent,rgba(56,217,169,0.35))" }} />
        <span style={{
        ...
        <div style={{ flex: 1, height: 1, background: "linear-gradient(90deg,rgba(56,217,169,0.35),transparent)" }} />
      </div>
      ...
      <button
        ...
        style={{
          ...
          background: hovered
            ? "linear-gradient(135deg,rgba(56,217,169,0.14),rgba(204,93,232,0.1))"
            : "linear-gradient(135deg,rgba(56,217,169,0.07),rgba(204,93,232,0.05))",
          border: `1.5px solid ${hovered ? "rgba(56,217,169,0.55)" : "rgba(56,217,169,0.2)"}`,
          borderRadius: 22, padding: "18px 22px",
          cursor: "pointer",
          transition: "all 0.3s cubic-bezier(.34,1.56,.64,1)",
          transform: hovered ? "translateY(-3px) scale(1.01)" : "none",
          boxShadow: hovered
            ? "0 12px 40px rgba(56,217,169,0.18), 0 4px 16px rgba(0,0,0,0.4)"
            : "0 2px 12px rgba(0,0,0,0.25)",
          animation: "cardSlideIn 0.5s cubic-bezier(.34,1.56,.64,1) 0.1s both",
        }}
      >
        ...
        <div style={{ position: "relative", flexShrink: 0 }}>
          <div style={{
            ...
            background: hovered
              ? "linear-gradient(135deg,#38D9A9,#00897B)"
              : "linear-gradient(135deg,rgba(56,217,169,0.25),rgba(0,137,123,0.15))",
            border: "1.5px solid rgba(56,217,169,0.4)",
            display: "flex", alignItems: "center", justifyContent: "center",
            transition: "all 0.3s ease",
            boxShadow: hovered ? "0 6px 24px rgba(56,217,169,0.4)" : "none",
          }}>
            <svg width={22} height={22} viewBox="0 0 24 24" fill="none"
              stroke={hovered ? "#fff" : "#38D9A9"} strokeWidth={2} strokeLinecap="round"
        ...
        <div style={{ flex: 1, textAlign: "left" }}>
          <div style={{
            ...
            fontSize: "1rem", color: "#fff", marginBottom: 3,
          ...
          <div style={{
            ...
            fontSize: "0.78rem",
            color: hovered ? "rgba(56,217,169,0.8)" : "rgba(255,255,255,0.38)",
            transition: "color 0.2s",
          }}>
        ...
        <svg width={18} height={18} viewBox="0 0 24 24" fill="none"
          stroke={hovered ? "#38D9A9" : "rgba(255,255,255,0.25)"}
          strokeWidth={2.3} strokeLinecap="round"
          style={{ flexShrink: 0, transition: "stroke 0.2s, transform 0.25s", transform: hovered ? "translateX(3px)" : "none" }}>
